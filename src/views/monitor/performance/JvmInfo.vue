...
import { jvmInfo } from '@/api/monitor/performance'
...
export default {
  ...
  methods: {
    ...
    loadTomcatInfo () {
      ...
      Promise.all([
        jvmInfo('jvm.memory.max'),
        jvmInfo('jvm.memory.committed'),
        jvmInfo('jvm.memory.used'),
        jvmInfo('jvm.buffer.memory.used'),
        jvmInfo('jvm.buffer.count'),
        jvmInfo('jvm.threads.daemon'),
        jvmInfo('jvm.threads.live'),
        jvmInfo('jvm.threads.peak'),
        jvmInfo('jvm.classes.loaded'),
        jvmInfo('jvm.classes.unloaded'),
        jvmInfo('jvm.gc.memory.allocated'),
        jvmInfo('jvm.gc.memory.promoted'),
        jvmInfo('jvm.gc.max.data.size'),
        jvmInfo('jvm.gc.live.data.size'),
        jvmInfo('jvm.gc.pause')
      ]).then((res) => {
        const info = []
